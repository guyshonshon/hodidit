...
interface Props { steps: SolutionStep[]; questions?: Question[]; githubUrl?: string | null }

export function SolutionStepList({ steps, questions = [], githubUrl }: Props) {
  if (steps.length === 0) {
    return (
        ...
        {groups.map((group, gi) => {
          ...
          return (
            <div key={gi} style={{ marginBottom: 24 }}>
              {/* Q-number divider — badge + line + optional GitHub link */}
